 ...
 */
public class GetRealtimeDataCommand extends GenericHATEOSGetCommand<RealtimeDataWrapper, RealtimeData> {
    ...
    public GetRealtimeDataCommand(String uri, String lineName, String direction, int stationNumber, Date from, Date to) {
